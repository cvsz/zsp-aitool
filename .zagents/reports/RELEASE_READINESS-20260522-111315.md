...
Generated: 2026-05-22T11:13:15+00:00
Branch: main
...
[22m[39m{
 ...
 [32m✓[39m tests/hyperframes-watchdog.test.ts [2m([22m[2m3 tests[22m[2m)[22m[33m 1126[2mms[22m[39m
     [33m[2m✓[22m[39m ok empty queue [33m 958[2mms[22m[39m
...
[22m[39m[OK] Alert sent (pending>=10)
 ...
 [32m✓[39m tests/hyperframes-worker-alerts.test.ts [2m([22m[2m6 tests[22m[2m)[22m[33m 321[2mms[22m[39m
...
[22m[39m[SKIP] HYPERFRAMES_RENDER_SMOKE_CONFIRM must be YES
 ...
 [32m✓[39m tests/hyperframes-enqueue-smoke-job.test.ts [2m([22m[2m6 tests[22m[2m)[22m[33m 762[2mms[22m[39m
     [33m[2m✓[22m[39m refuses when render is disabled [33m 683[2mms[22m[39m
 [32m✓[39m tests/hyperframes-render-smoke.test.ts [2m([22m[2m3 tests[22m[2m)[22m[33m 774[2mms[22m[39m
     [33m[2m✓[22m[39m refuses when render is disabled [33m 651[2mms[22m[39m
 [32m✓[39m tests/hyperframes-worker.test.ts [2m([22m[2m8 tests[22m[2m)[22m[33m 872[2mms[22m[39m
     [33m[2m✓[22m[39m keeps disabled worker path unchanged [33m 672[2mms[22m[39m
 [32m✓[39m tests/branding.test.ts [2m([22m[2m1 test[22m[2m)[22m[33m 649[2mms[22m[39m
     [33m[2m✓[22m[39m does not include deprecated product branding in product code paths [33m 641[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-download-token.test.ts [2m([22m[2m5 tests[22m[2m)[22m[33m 1182[2mms[22m[39m
     [33m[2m✓[22m[39m expired token rejected [33m 1113[2mms[22m[39m
 [32m✓[39m tests/security/security-compliance-static-scans.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 251[2mms[22m[39m
 [32m✓[39m tests/hyperframes-render-inventory.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 267[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-status.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 161[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-compose.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 283[2mms[22m[39m
 [32m✓[39m tests/security/hyperframes-security.test.ts [2m([22m[2m8 tests[22m[2m)[22m[32m 189[2mms[22m[39m
 [32m✓[39m tests/api/tenant-isolation.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 212[2mms[22m[39m
 [32m✓[39m tests/api/ocr-routes.test.ts [2m([22m[2m2 tests[22m[2m)[22m[33m 365[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-metrics.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 138[2mms[22m[39m
 [32m✓[39m tests/hyperframes-live-queue-trial-script.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 117[2mms[22m[39m
 [32m✓[39m tests/api/admin-backend-status.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 67[2mms[22m[39m
 [32m✓[39m tests/api/product-import-routes.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 73[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-script.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 289[2mms[22m[39m
 [32m✓[39m tests/hyperframes-safe-rollback.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 123[2mms[22m[39m
 [32m✓[39m tests/api/ai-generate-routes.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 100[2mms[22m[39m
 [32m✓[39m tests/services/AdminAuditLogService.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 13[2mms[22m[39m
 [32m✓[39m tests/hyperframes-worker-trial-script.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 119[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-history.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 200[2mms[22m[39m
 [32m✓[39m tests/api/content-workflow-hardening.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 297[2mms[22m[39m
 [32m✓[39m tests/hyperframes-asset-fetch.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 87[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-billing-gates.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 83[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-operator-controls.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 65[2mms[22m[39m
 [32m✓[39m tests/url-safety.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 100[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-brand-kit.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 121[2mms[22m[39m
 [32m✓[39m tests/product-validation.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 137[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-share.test.ts [2m([22m[2m6 tests[22m[2m)[22m[32m 143[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-org-scope.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 178[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-retry.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 252[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render.test.ts [2m([22m[2m8 tests[22m[2m)[22m[32m 197[2mms[22m[39m
 [32m✓[39m tests/services/BudgetService.test.ts [2m([22m[2m11 tests[22m[2m)[22m[32m 95[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-batch.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 198[2mms[22m[39m
 [32m✓[39m tests/hyperframes-templates.test.ts [2m([22m[2m9 tests[22m[2m)[22m[32m 90[2mms[22m[39m
 [32m✓[39m tests/lib/rate-limit-distributed.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 54[2mms[22m[39m
 [32m✓[39m tests/api/export-routes-headers.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 136[2mms[22m[39m
 [32m✓[39m tests/docs/enterprise-readiness-scale-plan-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 42[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-social-export.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 69[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-download.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 97[2mms[22m[39m
 [32m✓[39m tests/services/hyperframes-script-service.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 45[2mms[22m[39m
 [32m✓[39m tests/api/auth-routes.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 88[2mms[22m[39m
 [32m✓[39m tests/api/templates-crud.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 40[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-variants.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 108[2mms[22m[39m
 [32m✓[39m tests/components/all-menu-coverage-static.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 50[2mms[22m[39m
 [32m✓[39m tests/scripts/backup-db-static.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 18[2mms[22m[39m
 [32m✓[39m tests/security/admin-audit-redaction.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 11[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-quota.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 83[2mms[22m[39m
 [32m✓[39m tests/api/hyperframes-render-thumbnail.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 74[2mms[22m[39m
 [32m✓[39m tests/api/feedback-api.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 96[2mms[22m[39m
 [32m✓[39m tests/api/settings-route.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 37[2mms[22m[39m
 [32m✓[39m tests/scripts/backend-monitor-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 34[2mms[22m[39m
 [32m✓[39m tests/api/shopee-open-api-status.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 41[2mms[22m[39m
 [32m✓[39m tests/security/backend-monitor-redaction-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 34[2mms[22m[39m
 [32m✓[39m tests/api/admin-analytics.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 76[2mms[22m[39m
 [32m✓[39m tests/api/marqeta-status.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 61[2mms[22m[39m
 [32m✓[39m tests/hyperframes-render-validation.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 38[2mms[22m[39m
 [32m✓[39m tests/components/full-ux-ui-final-release-static.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 60[2mms[22m[39m
 [32m✓[39m tests/scripts/db-schema-drift-check-static.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 43[2mms[22m[39m
 [32m✓[39m tests/components/hyperframes-template-browser-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 28[2mms[22m[39m
 [32m✓[39m tests/hyperframes-render-command.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 32[2mms[22m[39m
 [32m✓[39m tests/hyperframes-subtitles.test.ts [2m([22m[2m5 tests[22m[2m)[22m[32m 37[2mms[22m[39m
 [32m✓[39m tests/hyperframes-template-marketplace.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 28[2mms[22m[39m
 [32m✓[39m tests/runbooks/backup-restore-release-static.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 34[2mms[22m[39m
 [32m✓[39m tests/components/shopee-open-api-import-static.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 15[2mms[22m[39m
 [32m✓[39m tests/services/ShopeeOpenApiService.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 57[2mms[22m[39m
 [32m✓[39m tests/services/MarqetaCoreApiService.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 108[2mms[22m[39m
 [32m✓[39m tests/security/marqeta-secret-redaction-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 12[2mms[22m[39m
 [32m✓[39m tests/export-panel-security.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 16[2mms[22m[39m
 [32m✓[39m tests/hyperframes-sanitize.test.ts [2m([22m[2m10 tests[22m[2m)[22m[32m 73[2mms[22m[39m
 [32m✓[39m tests/docs/high-priority-test-coverage-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 22[2mms[22m[39m
 [32m✓[39m tests/components/final-ui-admin-hyperframes-audit.test.ts [2m([22m[2m7 tests[22m[2m)[22m[32m 97[2mms[22m[39m
 [32m✓[39m tests/api/usage-summary.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 29[2mms[22m[39m
 [32m✓[39m tests/components/hyperframes-dashboard-render-button-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 20[2mms[22m[39m
 [32m✓[39m tests/middleware.auth.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 37[2mms[22m[39m
 [32m✓[39m tests/lib/shopee-open-api-config.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 29[2mms[22m[39m
 [32m✓[39m tests/components/hyperframes-upgrade-cta.test.tsx [2m([22m[2m1 test[22m[2m)[22m[32m 32[2mms[22m[39m
 [32m✓[39m tests/components/background-color-select-static.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 37[2mms[22m[39m
 [32m✓[39m tests/api/products.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 30[2mms[22m[39m
 [32m✓[39m tests/services/AuthValidation.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 13[2mms[22m[39m
 [32m✓[39m tests/hyperframes-render-quality.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 37[2mms[22m[39m
 [32m✓[39m tests/services/OCRService.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 44[2mms[22m[39m
 [32m✓[39m tests/services/ProductService.hardening.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 22[2mms[22m[39m
 [32m✓[39m tests/components/dashboard-pages-states.test.tsx [2m([22m[2m1 test[22m[2m)[22m[32m 28[2mms[22m[39m
 [32m✓[39m tests/components/admin-audit-logs-static.test.tsx [2m([22m[2m1 test[22m[2m)[22m[32m 29[2mms[22m[39m
 [32m✓[39m tests/services/ProductService.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 42[2mms[22m[39m
 [32m✓[39m tests/lib/marqeta-config.test.ts [2m([22m[2m4 tests[22m[2m)[22m[32m 46[2mms[22m[39m
 [32m✓[39m tests/services/AIContentService.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 22[2mms[22m[39m
 [32m✓[39m tests/services/SimilarProductService.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 29[2mms[22m[39m
 [32m✓[39m tests/docs/growth-runbook-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 19[2mms[22m[39m
 [32m✓[39m tests/components/theme-mode-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 26[2mms[22m[39m
 [32m✓[39m tests/scripts/db-critical-schema-drift-static.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 64[2mms[22m[39m
 [32m✓[39m tests/security/extension-permissions.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 91[2mms[22m[39m
 [32m✓[39m tests/components/growth-analytics-feedback-static.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 20[2mms[22m[39m
 [32m✓[39m tests/hyperframes-cleanup-timer.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 33[2mms[22m[39m
 [32m✓[39m tests/services/ExportService.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 16[2mms[22m[39m
 [32m✓[39m tests/components/growth-copy-safety-static.test.ts [2m([22m[2m2 tests[22m[2m)[22m[32m 44[2mms[22m[39m
 [32m✓[39m tests/api/admin-audit-logs.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 14[2mms[22m[39m
 [32m✓[39m tests/lib.hyperframes-billing.test.ts [2m([22m[2m3 tests[22m[2m)[22m[32m 92[2mms[22m[39m
 [32m✓[39m tests/hyperframes-render-safety.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 16[2mms[22m[39m
 [32m✓[39m tests/components/hyperframes-quota-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 34[2mms[22m[39m
 [32m✓[39m tests/components/hyperframes-render-history-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 20[2mms[22m[39m
 [32m✓[39m tests/components/mobile-nav-coverage-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 16[2mms[22m[39m
 [32m✓[39m tests/smoke.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 10[2mms[22m[39m
 [32m✓[39m tests/services/BackendMonitorService.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 14[2mms[22m[39m
 [32m✓[39m tests/docs/marqeta-runbook-static.test.ts [2m([22m[2m1 test[22m[2m)[22m[32m 14[2mms[22m[39m
 [32m✓[39m tests/components/admin-backend-monitor-static.test.tsx [2m([22m[2m1 test[22m[2m)[22m[32m 12[2mms[22m[39m

[2m Test Files [22m [1m[32m110 passed[39m[22m[90m (110)[39m
[2m      Tests [22m [1m[32m355 passed[39m[22m[90m (355)[39m
[2m   Start at [22m 11:13:21
[2m   Duration [22m 58.43s[2m (transform 12.77s, setup 39.45s, import 34.35s, tests 13.77s, environment 229.96s)[22m
...
Generated: 2026-05-22T11:16:20+00:00
...
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:128:- [INFO] docs/prompts/015-production-launch-polish.prompt.md:44:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:129:- [INFO] docs/prompts/015-production-launch-polish.prompt.md:53:- Use prisma migrate deploy, not prisma migrate dev, on production.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:130:- [INFO] docs/prompts/015-production-launch-polish.prompt.md:204:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:131:- [INFO] docs/prompts/015-production-launch-polish.prompt.md:211:sudo systemctl stop zsp-hyperframes-worker && sudo systemctl disable zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:132:- [INFO] docs/prompts/zsp-aitool-step-by-step-th.md:47:- ห้าม npm audit fix --force
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:133:- [INFO] docs/prompts/zsp-aitool-step-by-step-th.md:49:- Production ใช้ prisma migrate deploy เท่านั้น ห้าม prisma migrate dev
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:134:- [INFO] docs/prompts/zsp-aitool-step-by-step-th.md:173:- ห้าม npm audit fix --force
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:135:- [INFO] docs/prompts/zsp-aitool-step-by-step-th.md:229:ใช้ npx prisma migrate deploy --schema prisma/schema.prisma เท่านั้น ห้าม prisma migrate dev บน production
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:136:- [INFO] docs/prompts/zsp-aitool-step-by-step-th.md:686:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:137:- [INFO] docs/prompts/032-shopee-affiliate-portal-integration-polish.prompt.md:55:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:138:- [INFO] docs/prompts/017-first-100-users-growth-loop.prompt.md:48:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:139:- [INFO] docs/prompts/017-first-100-users-growth-loop.prompt.md:50:- Use prisma migrate deploy, not prisma migrate dev, on production.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:140:- [INFO] docs/prompts/016-post-launch-monitoring-and-growth.prompt.md:46:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:141:- [INFO] docs/prompts/016-post-launch-monitoring-and-growth.prompt.md:55:- Use prisma migrate deploy, not prisma migrate dev, on production.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:142:- [INFO] docs/prompts/016-post-launch-monitoring-and-growth.prompt.md:254:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:143:- [INFO] docs/prompts/020-production-db-schema-drift-hardening-and-settings-migration.prompt.md:38:- Do not run `npm audit fix --force`.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:144:- [INFO] docs/prompts/020-production-db-schema-drift-hardening-and-settings-migration.prompt.md:44:- Use `prisma migrate deploy` on production.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:145:- [INFO] docs/prompts/020-production-db-schema-drift-hardening-and-settings-migration.prompt.md:155:- migration/runbook mentions production uses `prisma migrate deploy`, not `migrate dev`
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:146:- [INFO] docs/prompts/020-production-db-schema-drift-hardening-and-settings-migration.prompt.md:182:- production migration policy: use `npx prisma migrate deploy`, never `migrate dev`
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:147:- [INFO] docs/prompts/020-production-db-schema-drift-hardening-and-settings-migration.prompt.md:238:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:148:- [INFO] docs/prompts/021-growth-analytics-and-feedback-dashboard.prompt.md:40:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:149:- [INFO] docs/prompts/005-final-full-repo-production-readiness.prompt.md:61:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:150:- [INFO] docs/prompts/005-final-full-repo-production-readiness.prompt.md:73:- Use prisma migrate deploy, not prisma migrate dev, on production.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:151:- [INFO] docs/prompts/005-final-full-repo-production-readiness.prompt.md:260:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:152:- [INFO] docs/prompts/014-full-ux-ui-redesign.prompt.md:24:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:153:- [INFO] docs/prompts/033-shopee-affiliate-automation-safe-ingestion.prompt.md:89:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:154:- [INFO] docs/prompts/036-shopee-affiliate-persist-social-drafts.prompt.md:61:- Do not run `npm audit fix --force`.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:155:- [INFO] docs/prompts/036-shopee-affiliate-persist-social-drafts.prompt.md:154:Use `npx prisma migrate deploy --schema prisma/schema.prisma` in production only.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:156:- [INFO] docs/prompts/018-official-shopee-open-api-integration.prompt.md:48:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:157:- [INFO] docs/prompts/018-official-shopee-open-api-integration.prompt.md:50:- Use prisma migrate deploy, not prisma migrate dev, on production.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:158:- [INFO] docs/prompts/zsp-aitool-full-source-en.md:46:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:159:- [INFO] docs/prompts/zsp-aitool-full-source-en.md:48:- Use prisma migrate deploy, not prisma migrate dev, on production.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:160:- [INFO] docs/prompts/zsp-aitool-full-source-en.md:215:- production migration warning: use prisma migrate deploy only on production
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:161:- [INFO] docs/prompts/zsp-aitool-full-source-en.md:502:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:162:- [INFO] docs/prompts/019-full-ux-ui-final-release-day-night-system.prompt.md:48:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:163:- [INFO] docs/prompts/019-full-ux-ui-final-release-day-night-system.prompt.md:63:- Use prisma migrate deploy, not prisma migrate dev, on production.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:164:- [INFO] docs/prompts/029-security-compliance-and-abuse-prevention.prompt.md:36:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:165:- [INFO] docs/hyperframes-render-worker.md:119:sudo systemctl enable zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:166:- [INFO] docs/hyperframes-render-worker.md:120:sudo systemctl start zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:167:- [INFO] docs/hyperframes-render-worker.md:139:sudo systemctl stop zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:168:- [INFO] docs/hyperframes-render-worker.md:140:sudo systemctl disable zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:169:- [INFO] docs/hyperframes-render-worker.md:206:- When `HYPERFRAMES_RENDER_ENABLED=true`, the script calls `systemctl start`, sleeps for the trial window, requires the service to remain active, then stops the service.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:170:- [INFO] docs/hyperframes-render-worker.md:210:- The script does not call `systemctl enable` and does not modify `.env`.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:171:- [INFO] docs/hyperframes-render-worker.md:223:sudo systemctl stop zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:172:- [INFO] docs/hyperframes-render-worker.md:224:sudo systemctl disable zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:173:- [INFO] docs/hyperframes-render-worker.md:246:- No `systemctl enable` calls.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:174:- [INFO] docs/hyperframes-render-worker.md:283:4. Runs `systemctl daemon-reload` and `systemctl start`.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:175:- [INFO] docs/hyperframes-render-worker.md:299:sudo systemctl stop zsp-hyperframes-worker || true
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:176:- [INFO] docs/hyperframes-render-worker.md:353:sudo systemctl stop zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:177:- [INFO] docs/hyperframes-render-worker.md:354:sudo systemctl disable zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:178:- [INFO] docs/production-readiness-checklist.md:127:- [ ] **Required before launch**: ใช้ `prisma migrate deploy` ในขั้น deploy production
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:179:- [INFO] docs/runbooks/production-deployment-checklist.md:29:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:180:- [INFO] docs/runbooks/production-backup-restore.md:9:- production migration ใช้ `npx prisma migrate deploy --schema prisma/schema.prisma` เท่านั้น
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:181:- [INFO] docs/runbooks/production-backup-restore.md:62:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:182:- [INFO] docs/runbooks/production-launch.md:44:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:183:- [INFO] docs/runbooks/production-launch.md:61:sudo systemctl stop zsp-hyperframes-worker && sudo systemctl disable zsp-hyperframes-worker
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:184:- [INFO] docs/runbooks/production-db-drift.md:46:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:185:- [INFO] docs/runbooks/security-compliance-abuse-prevention.md:22:- no direct `systemctl start|stop|restart|enable|disable` controls in UI
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:186:- [INFO] docs/runbooks/enterprise-readiness-scale-plan.md:43:- Scripted health checks and production-safe migration workflow (`prisma migrate deploy` guidance).
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:187:- [INFO] docs/runbooks/release-checklist.md:32:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:190:./.gemini/commands/admin-phase.toml:16:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:191:./.gemini/commands/hyperframes-phase.toml:18:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:192:./AGENTS.md:16:- Do not run npm audit fix --force.
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:193:./README.md:206:npx prisma migrate deploy --schema prisma/schema.prisma
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:194:./GEMINI.md:107:npm audit fix --force
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:195:./GEMINI.md:111:rm -rf /
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:196:./GEMINI.md:112:sudo systemctl start ...
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:197:./GEMINI.md:113:sudo systemctl stop ...
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:198:./GEMINI.md:114:sudo systemctl enable ...
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:199:./GEMINI.md:115:sudo systemctl disable ...
./.zagents/reports/ZSP_DEEP_DIVE_REPORT-20260522-111620.md:200:./GEMINI.md:116:terraform apply
